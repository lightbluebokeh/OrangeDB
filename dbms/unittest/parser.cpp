...
TEST_CASE("Testing tb_stmt", "[parser]") {
    ...
    REQUIRE(!ast.stmt_list[0].tb().insert_into().columns.has_value());
    ...
    REQUIRE(ast.stmt_list[0].tb().insert_into().values_list[0][1].is_float());
    REQUIRE(ast.stmt_list[0].tb().insert_into().values_list[0][1].to_float() == 1.3);
    REQUIRE(ast.stmt_list[0].tb().insert_into().values_list[0][2].is_string());
    REQUIRE(ast.stmt_list[0].tb().insert_into().values_list[0][2].to_string().empty());
    REQUIRE(ast.stmt_list[0].tb().insert_into().values_list[0][3].is_null());
    REQUIRE(ast.stmt_list[0].tb().insert_into().values_list[0][4].is_string());

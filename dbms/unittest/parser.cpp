...
TEST_CASE("Testing tb_stmt", "[parser]") {
    ...
    REQUIRE(ast.stmt_list[0].tb().create().fields[0].def().type.kind == ORANGE_NUMERIC);
    ...
    REQUIRE(ast.stmt_list[0].tb().create().fields[1].def().type.kind == ORANGE_VARCHAR);
    ...
    REQUIRE(ast.stmt_list[0].tb().create().fields[2].def().type.kind == ORANGE_INT);
    ...
    REQUIRE(ast.stmt_list[0].tb().insert_into().value_lists[0].size() == 5);
    REQUIRE(ast.stmt_list[0].tb().insert_into().value_lists[0][0].is_int());
    REQUIRE(ast.stmt_list[0].tb().insert_into().value_lists[0][0].to_int() == 1);
    REQUIRE(ast.stmt_list[0].tb().insert_into().value_lists[0][1].is_float() == true);
    REQUIRE(ast.stmt_list[0].tb().insert_into().value_lists[0][1].to_float() == 1.3);
    REQUIRE(ast.stmt_list[0].tb().insert_into().value_lists[0][2].is_string() == true);
    REQUIRE(ast.stmt_list[0].tb().insert_into().value_lists[0][2].to_string() == "");
    REQUIRE(ast.stmt_list[0].tb().insert_into().value_lists[0][3].is_null() == true);
    REQUIRE(ast.stmt_list[0].tb().insert_into().value_lists[0][4].is_string() == true);
    REQUIRE(ast.stmt_list[0].tb().insert_into().value_lists[0][4].to_string() == "abc  ");
